/**
 * @title Deploy with Public RPC
 * @dev Deploys YieldCircle using public RPC endpoints (no Infura required)
 */

const { ethers } = require("hardhat");
const { getNetworkConfig } = require('../config/testnet-addresses.js');

async function deployWithPublicRPC() {
    console.log('\n🚀 Deploying YieldCircle using public RPC endpoints...');
...
if (require.main === module) {
    deployWithPublicRPC().catch(console.error);
}

module.exports = { deployWithPublicRPC };
